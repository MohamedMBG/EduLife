# Task Audit - Remove Cover Project Name Line

## Date
2026-06-25

## Task Summary
Removed the cover-page overlay text `Nom du projet : EduLife` from the jury report.

## Files Created
- docs/2026-06-25-remove-cover-project-name-line.md

## Files Modified
- rapport PFA/edulife-pfa-jury.tex

## What Was Done
Deleted the `\raisebox` line that wrote `Nom du projet : EduLife` on the first page.
