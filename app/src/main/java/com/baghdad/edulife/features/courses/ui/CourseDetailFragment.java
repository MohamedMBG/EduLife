...
public class CourseDetailFragment extends Fragment {
    ...
    private View createLessonView(LessonSummary lesson) {
        ...
        // The detail screen exposes which lessons are previews versus locked so Sprint 2 can
        // demonstrate real course structure before Sprint 3 enrollment gates lesson access.
